...
//PV:IFCOND(pv:hasFeature('NavigationRing'))
const NavigationRing = require('./NavigationRing')
// PV:ENDCOND
        ...
        this.reloadTagsManager(config, () => {
          this.reloadContentAnnotator(config, () => {
            this.reloadUserFilter(config, () => {
                ...
                window.abwa.navigationRing = new NavigationRing()
                window.abwa.navigationRing.init()
            	// PV:ENDCOND
